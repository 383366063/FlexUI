...
*/
package net.lanelife.framework.preloaders
{
	...
	import net.lanelife.framework.catwindows.PreloaderDisplay;
	...
	public class DownloadProgressBar extends SparkDownloadProgressBar
	{
		...
		override protected function initCompleteHandler(event:Event):void
		{
			...
			preloaderDisplay.downloadText.text="";
		...
		{   
			...
			rt.height = 22;    
			rt.selectable = false;
			rt.text="(C) 2011-2012 LANELIFE.NET";
		...
		override protected function setDownloadProgress(completed:Number, total:Number):void {
			if (preloaderDisplay) {
				...
				preloaderDisplay.downloadText.text = size2str(completed)+" / "+size2str(total);
			}
		}
