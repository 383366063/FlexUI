package net.lanelife.framework.catwindows.components
{
	...
	net.lanelife.framework.catwindows.utils.LoaderUtil;
	...
	public class Window extends SkinnableContainer
	{
		...
		public function show():void
		{
			if (!created)
			{
				WindowEventDispatcher.getInstance().dispatchEvent(
					new WindowEvent(WindowEvent.WINDOW_CREATE+SystemVariables.currentDesktopScreenIndex, this)
				);
				created = true;
		...
		protected function destroy():void
		{
			...
			{
				WindowEventDispatcher.getInstance().dispatchEvent(
					new WindowEvent(WindowEvent.WINDOW_DESTROY+SystemVariables.currentDesktopScreenIndex, this)
				);
